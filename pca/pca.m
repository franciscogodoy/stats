% The data set contains measurements on seven air-pollution variables recorded
% at certain time in the Houston area on different days
pollution_data = load('airpollution.data');
